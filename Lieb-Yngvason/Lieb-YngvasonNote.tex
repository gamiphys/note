...
\begin{itembox}[l]{\textbf{熱力学第一法則}}
    熱力学第一法則とは、系の状態がある状態から別の状態に断熱的に移る際に、外界が行った仕事の量が、移行の行われ方に依らないことである。\\
...
\begin{equation}
    U-U_0 +\sum_{i=1}^n g_i(V_i-V_i^0) 
\end{equation}
により、$A_X$を表すことができるということである。\\
...
forward sector$A_X$は、空でない内部を持つ。すなわち、
\begin{equation}
    Int(A_X) \neq \emptyset
\end{equation}
である。
