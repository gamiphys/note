\documentclass[a3paper, twocolumn, 11pt]{jsarticle} 
 
% 「a3paper」でPDFのサイズをA3にしています．実際のポスターのサイズはA1の予定ですが，対応するコマンドが無いので，拡大して印刷します． 
% 「twocolumn」でPDFを2段組にしています． 
% 「11pt」でPDFの文字サイズを11ptにしています．10ptでは小さすぎるし，12ptでは大きすぎるような気がしたのでこれにしています． 
% LuaLaTeXではなくpLaTeXを使いたい人は，「ltjsarticle」を「jsarticle」に書き替えてください． 
...
\date{\today} % 日付は要らないような気もするのですが，消し方が分からなかったのでとりあえず残しておいています． 
